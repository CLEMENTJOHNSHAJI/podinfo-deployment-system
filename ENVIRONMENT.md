...
Note: The pipeline now reuses the existing EC2 Launch Template and creates a new version overriding only user data. EC2 AMI and Security Group IDs are not required as GitHub secrets.
