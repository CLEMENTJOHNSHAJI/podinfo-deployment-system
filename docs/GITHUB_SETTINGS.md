...
# Note: EC2 AMI and Security Group IDs are no longer required as secrets.
# The pipeline reuses the existing Launch Template and creates a new version
# overriding only user data during deployments.
